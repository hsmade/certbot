...
"""
test_certbot-dns-transip
----------------------------------
Tests for `certbot_dns_transip` module.
"""
...
class AuthenticatorTest(test_util.TempDirTestCase, dns_test_common.BaseAuthenticatorTest):
    ...
    def setUp(self):
        ...
        dns_test_common.write({"transip_key_file": RSA_KEY}, path)
        dns_test_common.write({"transip_username": USERNAME}, path)
...
class TransipClientTest(unittest.TestCase):
    id = 1
    ...
    def setUp(self):
        ...
        with self.tempfile as temp:
            temp.write(RSA_KEY)
        self.transip_client = _TransipClient(USERNAME, self.tempfile)

        self.manager = mock.MagicMock()
        self.transip_client.manager = self.manager
    ...
    def test_add_txt_record(self):
        ...
        self.transip_client.add_txt_record(DOMAIN, self.record_name, self.record_content)
    ...
    def test_del_txt_record(self):
        ...
        self.transip_client.del_txt_record(DOMAIN, self.record_name, self.record_content)
